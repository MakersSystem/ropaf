    ...
    <div class="row">
      <div class="col">
        <div class="card shadow" style="background-color: #003508;">
          ...
          <div class="card-body">
            <form method="POST" action="/proeco" enctype="multipart/form-data">
              {{ csrf_field() }}
                ...
                <div class="row">
                  <div class="col-lg-2">
                    <div class="form-group">
                      <input class="form-control form-control-alternative" name="pro_soc" type="number" placeholder="Porcentaje">
                    </div>
                  </div>
              ...
              <h6 class="heading-small text-muted">¿Que porcentaje de socios tiene algun tipo de certidicacion ecologica?</h6>
                <div class="row">
                  <div class="col-lg-2">
                    <div class="form-group">
                      <input class="form-control form-control-alternative" name="cer_soc" type="number" placeholder="Porcentaje">
                    </div>
                  </div>
                  <label for=""><h2 class="text-muted pt-2"><b>%</b></h2> </label>
                </div>
                ...
                <div class="row">
                  <div class="col-lg-8">
                    <div class="form-group">
                      ...
                      <textarea class="form-control form-control-alternative" name="sup_soc" rows="5" cols="80" placeholder="Escribir..."></textarea>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <div class="input-group input-group-alternative mb-4">
                        ...
                        <input type="file" name="adju" class="form-control">
