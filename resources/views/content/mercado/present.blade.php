        ...
        <div class="col">
          <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <h1 class="heading-large text-muted mb-4">Datos del Mercado de la Organizacion </h1>
                ...
                <hr class="my-4" />
                <!-- Description -->
                <a href="{{URL::action('MercadoController@create')}}" class="btn btn-primary">Agregar Informacion</a>
            </div>
          </div>
        </div>
      </div>
