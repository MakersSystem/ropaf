...
<html lang="en">
    ...
    <body>
        <div class="wrapper">
            <div class="sidebar" data-color="dark" data-image="{{asset('light')}}/img/sidebar-5.jpg">
                <div class="sidebar-wrapper">
                    <div class="logo">
                        <a href="#" class="simple-text">
                            <img src="{{asset('home')}}/img/cioec.gif" alt="" height="100">
                        </a>
                    </div>
                ...
                <nav class="navbar navbar-default navbar-fixed">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="#">CIOEC</a>
                        </div>
                    </div>
                </nav>
