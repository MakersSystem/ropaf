...
<html lang="en">
    ...
    <body>
        <div class="wrapper">
            <div class="sidebar" data-color="red" data-image="{{asset('light')}}/img/sidebar-5.jpg">
                <div class="sidebar-wrapper">
                    <div class="logo">
                        <a href="#" class="simple-text">
                            <img src="{{asset('home')}}/img/anproca.png" alt="" height="100">
                        </a>
                    </div>
                ...
                <nav class="navbar navbar-default navbar-fixed">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="#">ANPROCA</a>
                        </div>
                    </div>
                </nav>
